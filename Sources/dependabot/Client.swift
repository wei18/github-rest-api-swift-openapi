...
public struct Client: APIProtocol {
    ...
    public func dependabotRepositoryAccessForEnterprise(_ input: Operations.DependabotRepositoryAccessForEnterprise.Input) async throws -> Operations.DependabotRepositoryAccessForEnterprise.Output {
        try await client.send(
            input: input,
            forOperation: Operations.DependabotRepositoryAccessForEnterprise.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/enterprises/{}/dependabot/repository-access",
                    parameters: [
                        input.path.enterprise
                    ]
                )
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.DependabotRepositoryAccessForEnterprise.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func dependabotUpdateRepositoryAccessForEnterprise(_ input: Operations.DependabotUpdateRepositoryAccessForEnterprise.Input) async throws -> Operations.DependabotUpdateRepositoryAccessForEnterprise.Output {
        try await client.send(
            input: input,
            forOperation: Operations.DependabotUpdateRepositoryAccessForEnterprise.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/enterprises/{}/dependabot/repository-access",
                    parameters: [
    ...
    public func dependabotSetRepositoryAccessDefaultLevelForEnterprise(_ input: Operations.DependabotSetRepositoryAccessDefaultLevelForEnterprise.Input) async throws -> Operations.DependabotSetRepositoryAccessDefaultLevelForEnterprise.Output {
        try await client.send(
            input: input,
            forOperation: Operations.DependabotSetRepositoryAccessDefaultLevelForEnterprise.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/enterprises/{}/dependabot/repository-access/default-level",
                    parameters: [
                        input.path.enterprise
                    ]
                )
    ...
    ///
    /// - Remark: HTTP `GET /orgs/{org}/dependabot/repository-access`.
    /// - Remark: Generated from `#/paths//orgs/{org}/dependabot/repository-access/get(dependabot/repository-access-for-org)`.
    public func dependabotRepositoryAccessForOrg(_ input: Operations.DependabotRepositoryAccessForOrg.Input) async throws -> Operations.DependabotRepositoryAccessForOrg.Output {
        try await client.send(
            ...
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/orgs/{}/dependabot/repository-access",
                    parameters: [
                        input.path.org
                    ]
                )
    ...
    /// ```
    ///
    /// - Remark: HTTP `PATCH /orgs/{org}/dependabot/repository-access`.
    /// - Remark: Generated from `#/paths//orgs/{org}/dependabot/repository-access/patch(dependabot/update-repository-access-for-org)`.
    ...
    /// This operation supports both server-to-server and user-to-server access.
    ///
    /// - Remark: HTTP `PUT /orgs/{org}/dependabot/repository-access/default-level`.
    /// - Remark: Generated from `#/paths//orgs/{org}/dependabot/repository-access/default-level/put(dependabot/set-repository-access-default-level)`.
    public func dependabotSetRepositoryAccessDefaultLevel(_ input: Operations.DependabotSetRepositoryAccessDefaultLevel.Input) async throws -> Operations.DependabotSetRepositoryAccessDefaultLevel.Output {
        try await client.send(
            ...
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/orgs/{}/dependabot/repository-access/default-level",
                    parameters: [
                        input.path.org
                    ]
                )
